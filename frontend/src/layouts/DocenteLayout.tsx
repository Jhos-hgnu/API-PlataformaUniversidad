...
import docenteImg from '../assets/imagenes/docente.webp';
...
export const DocenteLayout: React.FC<DocenteLayoutProps> = ({ children, activeTab, setActiveTab }) => {
  ...
  const menuItems: { id: Section; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'cursos', label: 'Mis Cursos', icon: <BookOpen size={18} /> },
    { id: 'notas', label: 'Actas de Notas', icon: <FileSpreadsheet size={18} /> },
  ...
  const headerTitleMap: Record<Section, string> = {
    ...
    cursos: 'Mis Cursos Asignados',
    notas: 'Control de Notas',
